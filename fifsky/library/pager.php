...
class Pager
{
    ...
    /**
     * @var \fifsky\library\MyPDO;
     */
    private $data_provider;

    public function init($dao, $curr_page = 1, $per_page = 10)
    {
    ...
    public function setCountMax($num)
    {
        $this->max_count = $num;
    }
    ...
    public function getAllResult($cmd, $params)
    {
        return $this->data_provider['select']->getAll($cmd, $params);
    }
